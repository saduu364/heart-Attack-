...
systolic_bp = st.number_input("Systolic Blood Pressure (systolic_bp)", min_value=80, max_value=200, value=120)
diastolic_bp = st.number_input("Diastolic Blood Pressure (diastolic_bp)", min_value=50, max_value=130, value=80)
