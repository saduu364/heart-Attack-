...
# === On Submit ===
if submitted:
    # Prepare dictionary (graph features hidden but default 0 values added)
    input_dict = {
        ...
        'ca': ca,
        'thal': thal,
        # hidden graph features default values
        'pageRank': 0,
        'betweenness': 0,
        'community': 0,
        'degree': 0,
    ...
    # Show entered data
    st.markdown("---")
    st.markdown("### 🔢 Entered Patient Data (with hidden graph defaults)")
